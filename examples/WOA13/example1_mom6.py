...
temp_south.interpolate_from( woatemp,'temp',frame=0,depthname='st_ocean',coord_names=['geolon_t','geolat_t'])
temp_north.interpolate_from( woatemp,'temp',frame=0,depthname='st_ocean',coord_names=['geolon_t','geolat_t'])
temp_west.interpolate_from(  woatemp,'temp',frame=0,depthname='st_ocean',coord_names=['geolon_t','geolat_t'])

salt_south.interpolate_from( woasalt,'salt',frame=0,depthname='st_ocean',coord_names=['geolon_t','geolat_t'])
salt_north.interpolate_from( woasalt,'salt',frame=0,depthname='st_ocean',coord_names=['geolon_t','geolat_t'])
salt_west.interpolate_from(  woasalt,'salt',frame=0,depthname='st_ocean',coord_names=['geolon_t','geolat_t'])
