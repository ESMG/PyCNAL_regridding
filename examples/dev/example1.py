...
south = los.obc_segment('segment_01',romsgrd,target_model='ROMS',imin=1,imax=100,jmin=1,jmax=1,nvertical=33)
north = los.obc_segment('segment_02',romsgrd,target_model='ROMS',imin=1,imax=100,jmin=400,jmax=400,nvertical=33)
